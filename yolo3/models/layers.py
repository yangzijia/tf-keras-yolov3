...
from tensorflow._api.v1.keras.layers import Conv2D, DepthwiseConv2D, Concatenate, MaxPooling2D
from tensorflow._api.v1.keras.layers import LeakyReLU, UpSampling2D
...
def make_depthwise_separable_last_layers(x, num_filters, out_filters, block_id_str=None, predict_filters=None):
    ...
    if predict_filters is None:
        predict_filters = num_filters * 2
    y = compose(
        Depthwise_Separable_Conv2D_BN_Leaky(filters=predict_filters, kernel_size=(3, 3),
